"use strict";(self.webpackChunkmy_project=self.webpackChunkmy_project||[]).push([[4121],{11199:(H,L,t)=>{t.r(L),t.d(L,{default:()=>fe});var e=t(67294),a=t(64289),b=t(87751),f=t(16550),T=t(86896),y=t(14087),p=t(17034),M=t(185),O=t(53979),E=t(36989),d=t(75515),h=t(29728),S=t(49066),W=t(41580),ne=t(38939),oe=t(49386),se=t(8060),G=t(79031),m=t(37909),N=t(92155),le=t(63237),ae=t(15234),R=t(11047),C=t(85893),x=t(45697),V=t(46449);const $=V.ZP.div`
...
`,E=(0,f.ZP)(T.x)`
  ...
  width: 100%;
  border: none;
`,d=({children:h,icon:S,...W})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(y.i,{}),(0,e.jsx)(E,{as:"button",background:"primary100",padding:5,...W,children:(0,e.jsxs)(p.k,{children:[(0,e.jsx)(O,{"aria-hidden":!0,background:"primary200",children:S}),(0,e.jsx)(T.x,{paddingLeft:3,children:(0,e.jsx)(M.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:h})})]})})]});d.propTypes={children:b.string.isRequired,icon:b.node.isRequired}}}]);
